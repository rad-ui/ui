...
export default {
  ...
  render: (args) => (
    <SandboxEditor>
      <div
        className=" bg-gray-400 p-4 overflow-auto"
        style={{ height: '200px' }}
      >
        <div className="block" style={{ height: '400px' }}>
          ...
          >
            <div>
              Hello this is a dropdown. Hello this is a dropdown. Hello this is
              a dropdown. Hello this is a dropdown. Hello this is a dropdown.
              Hello this is a dropdown. Hello this is a dropdown. Hello this is
              a dropdown. Hello this is a dropdown. Hello this is a dropdown.
              Hello this is a dropdown. Hello this is a dropdown. Hello this is
              a dropdown. Hello this is a dropdown. Hello
            </div>
          </Dropdown>
