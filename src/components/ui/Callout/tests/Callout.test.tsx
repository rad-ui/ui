...
describe('Callout', () => {
  describe('Callout.Root', () => {
    ...
    it('applies color prop correctly', () => {
      ...
      const element = screen.getByText('Test Content').parentElement;
      expect(element?.parentElement).toHaveAttribute('data-rad-ui-accent-color', 'red');
    });
    ...
    it('applies variant prop correctly', () => {
      ...
      const element = screen.getByText('Test Content').parentElement;
      expect(element?.parentElement).toHaveAttribute('data-callout-variant', 'soft');
    });
    ...
    it('applies size prop correctly', () => {
      ...
      const element = screen.getByText('Test Content').parentElement;
      expect(element?.parentElement).toHaveAttribute('data-callout-size', 'large');
    });
  });
