            ...
            <MenuPrimitive.Root>
                ...
                <MenuPrimitive.Portal>
                    <MenuPrimitive.Content className="flex flex-col mt-2 bg-[var(--rad-ui-surface-inverse)] border border-[var(--rad-ui-border-soft)] rounded shadow-lg min-w-[180px]">
                        ...
                        <MenuPrimitive.Item className="px-4 py-2 hover:bg-[var(--rad-ui-surface-subtle)] cursor-pointer rounded" label="item 2">item 2</MenuPrimitive.Item>
                        ...
                        <MenuPrimitive.Item className="px-4 py-2 hover:bg-[var(--rad-ui-surface-subtle)] cursor-pointer rounded">item 1</MenuPrimitive.Item>
                        <MenuPrimitive.Item className="px-4 py-2 hover:bg-[var(--rad-ui-surface-subtle)] cursor-pointer rounded">item 1</MenuPrimitive.Item>
                    </MenuPrimitive.Content>
                </MenuPrimitive.Portal>
            </MenuPrimitive.Root>
