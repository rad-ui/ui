...
export const BadgeTable ={
     ...
     data : [
        ...
        {prop: 'size', type: 'string', default: 'null', description: 'Size of the component', id: 'color'},
        {prop: 'variant', type: 'string', default: 'null', description: 'Variant of the component', id: 'color'},
