...
Patch and minor releases should be drop-in when the changelog reports no breaking changes. For **major** releases, follow the breaking-change section in the changelog, the [Migration guides](/docs/guides/migration-guides) index, and update any deprecated APIs.
