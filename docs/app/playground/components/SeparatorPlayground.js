        ...
        <div className='mt-4 space-y-2'>
            <ColorLooper loop={false} title="Separator">
                <div className='space-y-2 mb-8 bg-gray-200 py-4 px-4 rounded-md  shadow'>
                    <Heading className="text-gray-1000 flex space-x-2" as="h3"><span>Linkin Park</span><Separator orientation="vertical" /> <Em className="text-gray-900 font-light">Meteora</Em></Heading>
                    <Separator />
