...
const NavItem = ({ item, path,setIsDocsNavOpen }) => {
    ...
    const activeClasses = isCurrentPath ? 'bg-gray-300 font-medium text-gray-1000 border-gray-800' : 'border-gray-50 font-light text-gray-950 hover:bg-gray-100 hover:border-gray-1000'
