...
const NavItem = ({ item, path, setIsDocsNavOpen }) => {
    ...
    const activeClasses = isCurrentPath ? 'bg-gray-300 font-medium text-gray-900 border-gray-900' : 'border-gray-50 font-light text-gray-700 hover:bg-gray-100 hover:border-gray-800'
