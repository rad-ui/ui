...
const ComponentHero = ({ children, title='', codeUsage = {} }) => {
    ...
    return <div>
        ...
        <div className='bg-gradient-to-r from-green-50 to-gray-200  border border-gray-500 shadow-md p-10 rounded-tl-md rounded-tr-md text-gray-900 flex items-center justify-center justify-evenly overflow-x-auto '>
            {children}
        </div>
        <div>
            <div>
