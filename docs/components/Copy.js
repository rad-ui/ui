...
function Copy({ content }) {
    ...
    return (
        <span className = "flex items-center">
            <button
                onClick={handleCopy}
                className="inline-flex h-[34px] w-[34px] items-center justify-center rounded-[10px] border border-gray-300 bg-gray-50 text-gray-900 hover:bg-gray-100 hover:text-gray-1000">
